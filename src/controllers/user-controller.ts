...
import { CreateUserSchema, CreateUserSchemaResponse, ResponseErrorSchema } from '../view';
...
class UserController {
  ...
  async createUser(req: RequestWithBody<CreateUserSchema>, res: Response<CreateUserSchemaResponse | ResponseErrorSchema>) {
    try {
